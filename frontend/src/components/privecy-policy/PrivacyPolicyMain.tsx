              ...
              <div className="tab-content mb-60">
                ...
                >
                  <div className="terms_conditions_content">
                    ...
                    <p>
                      At <strong>ALLEMTIA</strong>, we value your privacy and are
                    ...
                    <p>
                      As a provider of the ALLEMTIA -eCommerce you may collect
                      and{" "}
                    ...
                    <p>
                      <Link className="link" href="ALLEMTIAadmin@gmail.com">
                       ALLEMTIAadmin@gmail.com
                      </Link>
                    </p>
                    <h4 className="info_title">
                ...
                >
                  <div className="terms_conditions_content">
                    ...
                    <p>
                      At ALLEMTIA, we are committed to
                ...
                >
                  <div className="terms_conditions_content">
                    ...
                    <p>
                      At <strong>ALLEMTIA</strong>, we strive to provide you with
                    ...
                    <ul className="icon_list  unordered_list_block">
                      <li>
                        ...
                        <span className="list_item_text">
                          ...
                          support team at ALLEMTIAsupport@gmail.com or 025142874.
                        </span>
                      </li>
                      <li>
                    ...
                    <ul className="icon_list  unordered_list_block">
                      <li>
                        ...
                        <span className="list_item_text">
                          <strong>ALLEMTIA</strong> reserves the right to update
                    ...
                    <p>
                      ...
                      us.
                      <br />
                      Thank you for choosing <strong>ALLEMTIA</strong>!
                    </p>
                  </div>
                  <RefundForm />
                </div>
