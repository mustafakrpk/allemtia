...
const GroupProductDetailsCard = ({ id }: propsType) => {
    ...
    const comboPackgeData = group_Package_Data?.filter(
        (group) => group.id == id
    );
                                                    ...
                                                    <div className='product-image pos-rel'>
                                                        ...
                                                        >
                                                            <Image
                                                                ...
                                                                src={
                                                                    item?.productImg as StaticImageData
                                                                }
                                                                alt='Ürün resmi'
                                                            />
                                                        </Link>
                                    ...
                                    <div className='product-image-nav'>
                                        <div className='product-nav-item animate-play pack-1-1'>
                                            ...
                                            <div className='pack-item-single hover-content'>
                                                <div className='product-image pos-rel'>
                                                    <Link
                                                        href={`/shop-details/${groupItemOne?.id}`}
                                                    >
                                                        <Image
                                                            style={{
                                                                width: "100%",
                                                            ...
                                                            src={
                                                                groupItemOne?.productImg as StaticImageData
                                                            }
                                                            alt='Ürün resmi'
                                                        />
                                                    </Link>
                                        ...
                                        <div className='product-nav-item animate-play pack-1-2'>
                                            ...
                                            <div className='pack-item-single hover-content'>
                                                <div className='product-image pos-rel'>
                                                    <Link
                                                        href={`/shop-details/${groupItemTwo?.id}`}
                                                    >
                                                        <Image
                                                            style={{
                                                                width: "100%",
                                                            ...
                                                            src={
                                                                groupItemTwo?.productImg as StaticImageData
                                                            }
                                                            alt='Ürün resmi'
                                                        />
                                                    </Link>
                                        ...
                                        <div className='product-nav-item animate-play pack-1-3'>
                                            ...
                                            <div className='pack-item-single hover-content'>
                                                <div className='product-image pos-rel'>
                                                    <Link
                                                        href={`/shop-details/${groupItemThree?.id}`}
                                                    >
                                                        <Image
                                                            style={{
                                                                width: "100%",
                                                            ...
                                                            src={
                                                                groupItemThree?.productImg as StaticImageData
                                                            }
                                                            alt='Ürün resmi'
                                                        />
                                                    </Link>
